...
Dieses Repository dient als solide, sofort einsatzbereite Basis für neue Java-25-Desktopanwendungen mit JavaFX.
Statt jedes Projekt von Grund auf neu aufzusetzen, liefert dieses Template alle wichtigen Konfigurationen,
Abhängigkeiten und Strukturen direkt mit – von der Build-Konfiguration über Logging bis hin zu Code-Qualitätsregeln.

Das Repo ist bewusst modular aufgebaut: Neben dem `main`-Branch existieren dedizierte **Feature- und Infra-Branches**,
die jeweils genau **eine** zusätzliche Sache abbilden und bei Bedarf ausgecheckt oder als Referenz genutzt werden können.

### Verfügbare Branches (Beispiele)

| Branch | Inhalt |
|---|---|
| `feature/dropzone` | Drag-&-Drop-Dateibereich für Datei-Uploads |
| `feature/jira-connection` | Anbindung einer Jira-REST-API |
| `infra/sonarqube` | SonarQube-Analyse-Konfiguration |
| `infra/gitlab-ci` | GitLab CI/CD Pipeline-Konfiguration |
